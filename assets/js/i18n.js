...
(function () {
  ...
  const translations = {
    es: {
      ...
      "about.mission.text": "Estamos para agradar a Dios, predicar a Cristo crucificado y hacer discípulos según las Escrituras.",
      "about.identity.title": "Identidad",
      "about.identity.text": "Congregación no denominacional. Hablamos donde la Biblia habla y callamos donde ella calla.",
      "about.history.title": "Historia",
      "about.history.text": "Iniciamos en 1983 con los hermanos Harold Paden, Alan McAfee y los esposos John y Dulce Cloward. El 20 de agosto de 1997 inauguramos nuestro edificio actual en la calle Caonabo #6 de Gazcue.",
      ...
      "ministries.see_all": "Ver todos los ministerios →",
      "ministries.summary_lead": "Estos son algunos de nuestros espacios. Conoce todos los ministerios y encuentra el tuyo.",
    ...
    en: {
      ...
      "about.mission.text": "We exist to please God, preach Christ crucified and make disciples according to Scripture.",
      "about.identity.title": "Identity",
      "about.identity.text": "Non-denominational congregation. We speak where the Bible speaks and remain silent where it is silent.",
      "about.history.title": "History",
      "about.history.text": "We began in 1983 with brothers Harold Paden, Alan McAfee, and the Cloward family. On August 20, 1997 we inaugurated our current building on Calle Caonabo #6 in Gazcue.",
      ...
      "ministries.see_all": "See all ministries →",
      "ministries.summary_lead": "These are a few of our communities. Discover all our ministries and find yours.",
